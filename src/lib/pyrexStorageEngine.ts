// ==========================================
// PYREX QUANTUM CORE: CUSTOM CLOUD STORAGE
// & PERMANENT ASSET ENGINE (LIGHT MODE)
// ==========================================

export class PyrexSpinnaStorageEngine {
    bucketName: string;
    localStorageKey: string;

    constructor() {
        this.bucketName = "pyrex-permanent-vault";
        this.localStorageKey = "pyrex_vault_index";
        this.initVault();
    }
...
export const pyrexVault = new PyrexSpinnaStorageEngine();
